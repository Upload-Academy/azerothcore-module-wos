...
@questdescription := "$N, as you know the orphanes often go hungry. If you could find the time to make and donate some bread it would mean the world to these kids. You'd be their hero!
",
@areadescription := "$N, as you know the orphanes often go hungry. If you could find the time to make and donate some bread it would mean the world to these kids. You'd be their hero!
",
@questcompletionlog := "Quest complete",
@requirednpcorgo1 := 0,
@requirednpcorgo2 := 0,
